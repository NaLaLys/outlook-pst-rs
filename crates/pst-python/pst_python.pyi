...
class PyMessage:
    ...
    def open_attachment(self, node_id_str: str, prop_ids: Optional[List[int]] = None) -> PyAttachment: ...

class PyAttachment:
    def properties(self) -> PyAttachmentProperties: ...
    def data(self) -> Optional[bytes]: ...

class PyAttachmentProperties:
    def get(self, prop_id: int) -> Any: ...
    def iter(self) -> Dict[str, Any]: ...
    def attachment_size(self) -> int: ...
    def attachment_method(self) -> int: ...
